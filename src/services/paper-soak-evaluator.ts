...
const scanDiagnosticsSchema = z.object({
  ...
  eligibleEventCount: z.number().int().nonnegative().optional(),
  staticEligibleEventCount: z.number().int().nonnegative().optional(),
  candidateEventCount: z.number().int().nonnegative().optional(),
  eligibleTokenCount: z.number().int().nonnegative(),
  participatingTokenCount: z.number().int().nonnegative().optional(),
  maxObservedResultCount: z.number().int().nonnegative().optional(),
...
const statusSchema = z.object({
  ...
  paperAutomation: z.object({
    ...
    eventsEvaluatedCount: z.number().int().nonnegative().optional(),
    incompleteEventCount: z.number().int().nonnegative().optional(),
    arbitrationCount: z.number().int().nonnegative().optional(),
    arbitrationRecomputeCount: z.number().int().nonnegative().optional(),
    staleArbitrationRejectionCount: z.number().int().nonnegative().optional(),
    skippedLockedSiblingQuoteCount: z.number().int().nonnegative().optional(),
    maxObservedResultCount: z.number().int().nonnegative().optional(),
  }),
