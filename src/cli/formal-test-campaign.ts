...
const preferencesResponseSchema = z.object({
  preferences: z.object({
    ...
    minBuyPriceCents: z.number().min(0.1).max(99),
    maxBuyPriceCents: z.number().min(0.1).max(99),
    targetSellPriceIncreaseCents: z.number().min(0).max(99),
    targetSellPriceMultiplier: z.number().nonnegative(),
...
function parsePreferences(
  ...
  return {
    configuration: {
      ...
      minBuyPriceCents: preferences.minBuyPriceCents,
      maxBuyPriceCents: preferences.maxBuyPriceCents,
      targetSellPriceIncreaseCents:
        preferences.targetSellPriceIncreaseCents,
      targetSellPriceMultiplier: preferences.targetSellPriceMultiplier,
